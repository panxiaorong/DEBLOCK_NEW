...
private:
	...
	Mat single_channel;
	Mat updated_single_channel_x;
	Mat updated_single_channel_y;
...
public:
	...
	Dual_Mode_Deblock_Learner(Mat channel, int height, int width)//, int height, int width
	{
		single_channel = Mat(height, width, CV_32F);
		updated_single_channel_x = Mat(height, width, CV_32F);
		updated_single_channel_y = Mat(height, width, CV_32F);
